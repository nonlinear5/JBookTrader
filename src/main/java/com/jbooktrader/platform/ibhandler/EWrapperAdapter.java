...
abstract class EWrapperAdapter implements EWrapper {
    ...
    @Override public void tickOptionComputation( int tickerId, int field, int tickAttrib, double impliedVol,
    ...
    @Override public void orderBound(long permId, int clientId, int orderId) {}
